...
class LastAverageSpeed extends RichFlatMapFunction<Tuple3<Long, AvgVehicleSpeedTuple, Long>, Tuple3<Long, LavTuple, Long>> {
    ...
    @Override
    public void flatMap(Tuple3<Long, AvgVehicleSpeedTuple, Long> tuple, Collector<Tuple3<Long, LavTuple, Long>> collector) throws Exception {
...
//        SYSStamp = input.getLongByField(BaseConstants.BaseField.SYSTEMTIMESTAMP);
        ...
        collector.collect(new Tuple3<>(timestamp, lavTuple, timestamp_ext)); // TODO msgId, SYSStamp apparently not used
    }
