...
public class Topology {
    ...
    public static void submit(StreamExecutionEnvironment streamExecutionEnvironment, Configuration configuration, String jobName) {
        try {
            // set up chaining
            ...
            JobExecutionResult result = streamExecutionEnvironment.execute(jobName);
            LOG.info("... exiting and dumping metrics");
            // measure throughput
