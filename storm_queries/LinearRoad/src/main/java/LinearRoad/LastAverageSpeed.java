...
class LastAverageSpeed extends BaseRichBolt {
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declare(new Fields("timestamp", "timestamp_ext", "lav"));
    }
...
//        SYSStamp = input.getLongByField(BaseConstants.BaseField.SYSTEMTIMESTAMP);
        ...
        this.outputCollector.emit(new Values(timestamp, timestamp_ext, lavTuple)); // TODO msgId, SYSStamp apparently not used
        //////////
