...
public class DrainSink extends BaseRichBolt {
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector outputCollector) {
        ...
        this.endLatencyStat = new AvgStat(Stats.statisticsFile(map, topologyContext, Stats.END_LATENCY_FILE));
        this.sinkThroughputStat = new CountStat(Stats.statisticsFile(map, topologyContext, Stats.SINK_THROUGHPUT_FILE));
        // initialize
