...
import queries.synthetic.SyntheticQueryFactoryBlocking;
...
public class ChainBlocking {

  public static final String NAME = ChainBlocking.class.getSimpleName();
  ...
  public static void main(String[] args) {
    ...
    Execution.execute(settings, Arrays
        .asList(new SyntheticQueryFactoryBlocking<>(settings, NAME, dataSource, 0)),
        settings.nqueries());
  }
